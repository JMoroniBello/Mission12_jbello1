...
function Heading() {
  return <h1 className="title">Below is the information for each college in NCAA basketball</h1>;
}
...
class Team extends React.Component<{
  ...
  render() {
    ...
    return (
      <div className="cardy">
        <img />
        <h2 className="schoolname">{oneTeam.school}</h2>
        <h3 className="schooldeet">Mascot: {oneTeam.name}</h3>
        <h3 className="schooldeet">City: {oneTeam.city}</h3>
        <h3 className="schooldeet">State: {oneTeam.state}</h3>
      </div>
    );
  }
}
